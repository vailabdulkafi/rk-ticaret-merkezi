...
const BrandsSettings = () => {
  ...
  const createMutation = useMutation({
    ...
    onError: (error) => {
      toast.error('Marka eklenirken hata oluştu: ' + error.message);
    },
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (error) => {
      toast.error('Marka güncellenirken hata oluştu: ' + error.message);
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) => {
      toast.error('Marka silinirken hata oluştu: ' + error.message);
    },
  });
    ...
    <>
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingBrand ? 'Marka Güncelle' : 'Yeni Marka Ekle'}
            </DialogTitle>
          </DialogHeader>
